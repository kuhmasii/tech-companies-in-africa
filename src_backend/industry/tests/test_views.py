...
class TechListViewTests(TestCase):
        ...
        def test_tech_list_view(self):
                ...
                self.assertQuerysetEqual(response.context['companies'], obj)
                self.assertTemplateUsed(response, "industry/tech_list.html")
        ...
        def test_tech_alphabeth_view(self):
                ...
                self.assertQuerysetEqual(response.context['alphabeth'], [obj])
                self.assertTemplateUsed(response, "industry/alphabeth.html")